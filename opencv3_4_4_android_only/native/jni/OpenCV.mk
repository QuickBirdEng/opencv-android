...
OPENCV_MODULES:=videostab superres stitching tracking xfeatures2d shape optflow reg structured_light datasets text ml stereo rgbd plot dnn_objdetect dnn xphoto ximgproc surface_matching ccalib saliency img_hash line_descriptor aruco fuzzy phase_unwrapping dpm hfs face photo bgsegm video xobjdetect objdetect calib3d features2d flann bioinspired highgui videoio imgcodecs imgproc core
